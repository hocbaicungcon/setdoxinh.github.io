const font=document.createElement('link');font.rel='stylesheet';font.href='https://fonts.googleapis.com/css2?family=Be+Vietnam+Pro:wght@400;500;600;700&display=swap';document.head.appendChild(font);document.documentElement.style.setProperty('--sans',"'Be Vietnam Pro',sans-serif");const toggle = document.querySelector('.menu-toggle');
